  ...
  return (
    ...
    <div>
        <div className='mark'>
            <br></br>
            <br></br>
        <marquee>Mandatory Profile password change after 365 days introduced for added security.| Purchase your credit card through online in our site|  Call us toll free on 1800 1234 and 1800 2100 and get a wide range of services through INNOVATE Contact Centre.</marquee>
        </div>
        <div className='offer'>
