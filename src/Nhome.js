...
export default function Home() {
  ...
  return (
    ...
    <div className='mark'>
            <br></br><br></br>
        <marquee> INNOVATE never asks for your Card/PIN/OTP/CVV details on phone, message or email. Please do not click on links received on your email or mobile asking your Bank/Card details.| 
        Customers who have installed “INNOVATE Secure OTP App” on their mobile and completed registration process will now receive Login OTP for OnlineINNOVATE.com on the app instead of SMS OTP.
</marquee>
        </div>
        <div className='offer'>
